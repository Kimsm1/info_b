...
<td style="width:100px;"><img src="https://cdn-icons-png.flaticon.com/512/25/25451.png" alt="..." id="img3"><%=bv.getHit()%></td>
<td style="width:100px;">댓글수 <%=bv.getReplycnt()%></td>
<td style="width:100px;">조회수 <%=bv.getViewcount() %></td>
</tr>
<tr >
<td >내용</td>
